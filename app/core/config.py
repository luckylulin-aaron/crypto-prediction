...
NFLX_MONTHLY_SMA100_DEFENSIVE_PARAMETERS = (
    _asset_registry.NFLX_MONTHLY_SMA100_DEFENSIVE_PARAMETERS
)
NFLX_MONTHLY_SMA100_DEFENSIVE_STRATEGY = (
    _asset_registry.NFLX_MONTHLY_SMA100_DEFENSIVE_STRATEGY
)
...
# NFLX needs its pre-test history to reconstruct the frozen monthly regime,
# while reported performance remains a rolling 750-session evaluation.
NFLX_RUNTIME_HISTORY_LOOKBACK_DAYS = 10 * 365
NFLX_RUNTIME_EVALUATION_ROWS = 750
