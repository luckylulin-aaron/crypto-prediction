...
class TestMAMACDStrategy(unittest.TestCase):
    """Test cases for MA-MACD combined strategy."""
    ...
    def test_buy_signal_when_both_ma_and_macd_positive(self):
        ...
        self.assertTrue(buy, "Should execute buy when both MA and MACD signals are positive")
    ...
    def test_sell_signal_when_both_ma_and_macd_negative(self):
        ...
        self.assertTrue(sell, "Should execute sell when both MA and MACD signals are negative")
    ...
    def test_strategy_registry_integration(self):
        ...
        self.assertIn("MA-MACD", STRATEGY_REGISTRY, "MA-MACD not in registry")
        self.assertTrue(callable(STRATEGY_REGISTRY["MA-MACD"]), "MA-MACD not callable")
