...
def create_mock_trader():
    ...
    trader.strat_dct = {"ADAPTIVE-MA-SELVES": []}
...
class TestAdaptiveMASelvesStrategy(unittest.TestCase):
    ...
    def test_buy_signal_with_adaptive_tolerance(self):
        ...
        self.assertFalse(
            sell, "Should not execute sell when price below adaptive tolerance"
        )
    ...
    def test_sell_signal_with_adaptive_tolerance(self):
        ...
        self.assertFalse(
            buy, "Should not execute buy when price above adaptive tolerance"
        )
    ...
    def test_no_action_when_price_within_tolerance(self):
        ...
        self.assertFalse(
            buy, "Should not execute buy when price within adaptive tolerance"
        )
        self.assertFalse(
            sell, "Should not execute sell when price within adaptive tolerance"
        )
        self.trader._record_history.assert_called_with(
    ...
    def test_strategy_registry_integration(self):
        ...
        self.assertIn(
            "ADAPTIVE-MA-SELVES",
            STRATEGY_REGISTRY,
            "ADAPTIVE-MA-SELVES not in registry",
        )
        self.assertTrue(
            callable(STRATEGY_REGISTRY["ADAPTIVE-MA-SELVES"]),
            "ADAPTIVE-MA-SELVES not callable",
        )
    ...
    def test_config_integration(self):
        ...
        self.assertIn(
            "ADAPTIVE-MA-SELVES", STRATEGIES, "ADAPTIVE-MA-SELVES not in config"
        )
