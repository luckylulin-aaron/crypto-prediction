...
class TestBollingerBandsStrategy(unittest.TestCase):
    ...
    def test_buy_signal_when_price_below_lower_band(self):
        ...
        self.trader.moving_averages["12"] = [95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 100]
    ...
    def test_strategy_registry_integration(self):
        ...
        self.assertTrue(callable(STRATEGY_REGISTRY["BOLL-BANDS"]), "BOLL-BANDS not callable")
