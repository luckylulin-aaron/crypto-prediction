#!/usr/bin/env python3
"""
Test script for MA-SELVES (Moving Average with Tolerance) strategy.
"""
...
from app.trading.strategies import strategy_moving_average_w_tolerance
...
class TestMASelvesStrategy(unittest.TestCase):
    """Test cases for MA-SELVES strategy."""
    ...
    def test_buy_signal_when_price_below_tolerance(self):
        ...
        # Price at 90 (10% below MA of 105)
        new_price = 94.5  # (1 - 0.1) * 105 = 94.5
        
        buy, sell = strategy_moving_average_w_tolerance(
    ...
    def test_sell_signal_when_price_above_tolerance(self):
        ...
        # Price at 116.0 (10% above MA of 105)
    ...
    def test_strategy_registry_integration(self):
        ...
        self.assertIn("MA-SELVES", STRATEGY_REGISTRY, "MA-SELVES not in registry")
        self.assertTrue(callable(STRATEGY_REGISTRY["MA-SELVES"]), "MA-SELVES not callable")
        
    def test_config_integration(self):
        """Test that strategy is in the config."""
        from app.core.config import STRATEGIES
        
        self.assertIn("MA-SELVES", STRATEGIES, "MA-SELVES not in config")
