...
class TestMASelvesStrategy(unittest.TestCase):
    ...
    def test_strategy_registry_integration(self):
        ...
        self.assertTrue(
            callable(STRATEGY_REGISTRY["MA-SELVES"]), "MA-SELVES not callable"
        )
    ...
    def test_config_integration(self):
        ...
        self.assertIn("MA-SELVES", SUPPORTED_STRATEGIES, "MA-SELVES not supported in config")
