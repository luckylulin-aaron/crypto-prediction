...
def create_mock_trader():
    ...
    trader.strat_dct = {"CONSERVATIVE-MA": []}
...
class TestConservativeMAStrategy(unittest.TestCase):
    ...
    def test_buy_signal_with_confirmation(self):
        ...
        self.assertTrue(
            buy, "Should execute buy when price below tolerance with confirmation"
        )
    ...
    def test_sell_signal_with_confirmation(self):
        ...
        self.assertTrue(
            sell, "Should execute sell when price above tolerance with confirmation"
        )
    ...
    def test_strategy_registry_integration(self):
        ...
        self.assertIn(
            "CONSERVATIVE-MA", STRATEGY_REGISTRY, "CONSERVATIVE-MA not in registry"
        )
        self.assertTrue(
            callable(STRATEGY_REGISTRY["CONSERVATIVE-MA"]),
            "CONSERVATIVE-MA not callable",
        )
