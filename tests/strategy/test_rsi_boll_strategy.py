...
class TestRSIBollStrategy(unittest.TestCase):
    ...
    def test_buy_signal_when_rsi_oversold_and_price_below_lower_band(self):
        ...
        self.assertTrue(
            buy, "Should execute buy when RSI oversold and price below lower band"
        )
    ...
    def test_sell_signal_when_rsi_overbought_and_price_above_upper_band(self):
        ...
        self.assertTrue(
            sell, "Should execute sell when RSI overbought and price above upper band"
        )
    ...
    def test_strategy_registry_integration(self):
        ...
        self.assertTrue(
            callable(STRATEGY_REGISTRY["RSI-BOLL"]), "RSI-BOLL not callable"
        )
