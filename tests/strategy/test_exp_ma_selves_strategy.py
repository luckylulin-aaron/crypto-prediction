...
class TestExpMASelvesStrategy(unittest.TestCase):
    ...
    def test_strategy_registry_integration(self):
        ...
        self.assertIn("EXP-MA-SELVES", STRATEGY_REGISTRY, "EXP-MA-SELVES not in registry")
        self.assertTrue(callable(STRATEGY_REGISTRY["EXP-MA-SELVES"]), "EXP-MA-SELVES not callable")
